...
class FlightCardExp extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            cityFrom: '',
    ...
    render() {
        return (
            <Card className="centered" style={{
                backgroundColor: 'white', color: 'black', minHeight: '40vh',
                ...
                <Container>
                    <Form onSubmit={this.handleSubmit}>
                        ...
                        <Container>
                            <br />
                            <h6><b><Icon name="plane" size="large"/>BOOK DOMESTIC FLIGHTS</b></h6>                            <div className="row" divided style={{ border: '1px solid #E1D5D3', borderRadius: 20 }}>
                                {/* FROM CITY DROPDOWN */}
                                ...
                                <div className="col-lg-3 text-left hoverEffect">
                                    <label className="fixit"><br />DEPARTURE: </label>
                                    <DatePicker
                                        name="departureDate"
                                    ...
                                    {/* <input name="departureDate" type="date" value={this.state.departureDate} onChange={this.handleChange.bind(this, 'departureDate')} className="resize noHover"></input> */}
                                </div>
                                <div className="col-lg-3 text-left hoverEffect">
                                    <label className="fixit"><br />PASSENGERS: </label>
...
export default withRouter(FlightCardExp)