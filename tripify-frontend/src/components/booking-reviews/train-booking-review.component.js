...
class FareSummary extends Component {
    ...
    constructor(props){
        ...
        let totalAmount = subAmount * this.props.trainDetails.travellersCount;
        this.state = {
            travellersCount: this.props.trainDetails.travellersCount,
    ...
    redirectToNext() {
        ...
        if(localStorage.getItem('isLoggedin') == "true") {
            this.props.history.push({
                ...
                state: {
                    booking: 'train',
                    trainDetails: this.props.trainDetails,
                    fareDetails: trainFareDetails,
                    travellersCount: this.props.trainDetails.travellersCount
                }
            });
        } else { 
...
export default class TrainBooking extends Component {
    constructor(props) {
        super(props);
        console.log(this.props.location.state.trainDetails);
        let dateHandler = new Date(this.props.location.state.trainDetails.departureDate);
        ...
        this.state = {
            arrivalTime: this.props.location.state.trainDetails.arrivalTime,
            cityFrom: this.props.location.state.trainDetails.cityFrom,
            cityTo: this.props.location.state.trainDetails.cityTo,
            departureDate: this.props.location.state.trainDetails.departureDate,
            departureTime: this.props.location.state.trainDetails.departureTime,
            departureDay: departureDay,
            duration: this.props.location.state.trainDetails.duration,
            trainName: this.props.location.state.trainDetails.trainName,
            trainNumber: this.props.location.state.trainDetails.trainNumber,
            seatPrice: this.props.location.state.trainDetails.seatPrice,
            travellersCount: this.props.location.state.trainDetails.travellersCount,
            value: 'no',
            totalAmount: 20
        }
        console.log(this.props.location.state.trainDetails)
                ...
                <Container>
                    <Grid style={{ paddingTop: '2%' }}>
                        <Grid.Row>                   
                                        ...
                                        <Grid>
                                            <Grid.Row>
                                                ...
                                                <p className="text-muted">
                                                    ...
                                                    {this.state.cityFrom.cityStation} <br />
                                                    Terminal 3
                                            </Grid.Column>
                                                <Grid.Column width={3}>
                                                    <h6>DURATION:</h6>
                                                ...
                                                <p className="text-muted">
                                                    ...
                                                    {this.state.cityTo.cityStation}<br />
                                                    Terminal 3
                                            </Grid.Column>
                                            </Grid.Row>
                                        </Grid>
                            ...
                            {/* Fare Summary */}
                            <Grid.Column width={4}>
                                <FareSummary history={this.props.history} seatPrice={this.state.seatPrice} trainDetails={this.state} insurance={this.state.value} totalAmount={this.state.totalAmount}/>
                             </Grid.Column>
                        </Grid.Row>
                    </Grid>
                </Container>
