...
class FareSummary extends Component {
    ...
    constructor(props){
        super(props);
            ...
            let totalAmount = subAmount * this.props.flightDetails.travellersCount;
            this.state = {
                travellersCount: this.props.flightDetails.travellersCount,
...
export default class FlightBooking extends Component {
    constructor(props) {
        super(props);
        let dateHandler = new Date(this.props.location.state.flightDetails.departureDate);
        ...
        this.state = {
            arrivalTime: this.props.location.state.flightDetails.arrivalTime,
            cityFrom: this.props.location.state.flightDetails.cityFrom,
            cityTo: this.props.location.state.flightDetails.cityTo,
            departureDate: this.props.location.state.flightDetails.departureDate,
            departureTime: this.props.location.state.flightDetails.departureTime,
            departureDay: departureDay,
            duration: this.props.location.state.flightDetails.duration,
            flightName: this.props.location.state.flightDetails.flightName,
            flightNumber: this.props.location.state.flightDetails.flightNumber,
            seatPrice: this.props.location.state.flightDetails.seatPrice,
            travellersCount: this.props.location.state.flightDetails.travellersCount,
            value: 'no',
            totalAmount: 20
        }
        console.log(this.props.location.state.flightDetails)
    }
    state = {}
                ...
                <Container>
                    <Grid style={{ paddingTop: '2%' }}>
                        <Grid.Row>                   
                                        ...
                                        <Grid>
                                            <Grid.Row>
                                                ...
                                                <p className="text-muted">
                                                    ...
                                                    {this.state.cityFrom.cityAirport} <br />
                                                    Terminal 3
                                            </Grid.Column>
                                                <Grid.Column width={3}>
                                                    <h6>DURATION:</h6>
                                                ...
                                                <p className="text-muted">
                                                    ...
                                                    {this.state.cityTo.cityAirport}<br />
                                                    Terminal 3
                                            </Grid.Column>
                                            </Grid.Row>
                                        </Grid>
                            ...
                            {/* Fare Summary */}
                            <Grid.Column width={4}>
                                <FareSummary history={this.props.history} seatPrice={this.state.seatPrice} insurance={this.state.value} totalAmount={this.state.totalAmount} flightDetails={this.state}/>
                             </Grid.Column>
                        </Grid.Row>
                    </Grid>
                </Container>
